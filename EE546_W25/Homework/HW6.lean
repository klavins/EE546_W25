...
If you are stuck with on a complicated theorem and do not know where to go next, consider going back to simpler problems. For example,

  - If you are working with matrices, can you limit your results to 2x2 matrices?
  - If you are working with infinite sums of matrices, can you work with infinite sums of real numbers?
...
Please plan to present everything in VSCode, with explanations in comments, your windows properly magnified, and without displaying any extraneously sub-windows.
